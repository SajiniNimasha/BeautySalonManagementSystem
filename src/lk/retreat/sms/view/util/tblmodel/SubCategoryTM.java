...
public class SubCategoryTM {
    ...
    public SubCategoryTM() {
    }

    public SubCategoryTM( String mainCategoryName, String subCategoryName, double subCategoryPrice) {
    ...
    public String toString() {
        return "SubCategoryTM{" + "mainCategoryName=" + mainCategoryName + ", subCategoryName=" + subCategoryName + ", subCategoryPrice=" + subCategoryPrice + '}';
    }
