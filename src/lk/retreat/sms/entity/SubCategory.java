...
public class SubCategory {
    ...
    public SubCategory( String mainCategoryName, String subCategoryName, double subCategoryPrice) {
    ...
    public String toString() {
        return "SubCategory{" + "mainCategoryName=" + mainCategoryName + ", subCategoryName=" + subCategoryName + ", subCategoryPrice=" + subCategoryPrice + '}';
    }
