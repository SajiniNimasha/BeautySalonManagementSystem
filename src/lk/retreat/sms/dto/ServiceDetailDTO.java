...
public class ServiceDetailDTO {
    ...
    public ServiceDetailDTO(String serviceDetailId, String category, String appId) {
    ...
    public String toString() {
        return "ServiceDetailDTO{" + "serviceDetailId=" + serviceDetailId + ", category=" + category + ", appId=" + appId + '}';
    }
