...
public class EmployeeDTO {
    ...
    public EmployeeDTO(String EmployeeId, String EmployeeName,String EmployeeAddress, int EmployeeTel, String EmployeeEmail,String EmpFirstInDate) {
    ...
    public EmployeeDTO(String id, String name, String address, int tele, String emil) {
        this.EmployeeId = id;
        this.EmployeeName = name;
        
        this.EmployeeAddress = address;
        this.EmployeeTel = tele;
        this.EmployeeEmail = emil; }
    ...
    public String toString() {
        return "EmployeeDTO{" + "EmployeeId=" + EmployeeId + ", EmployeeName=" + EmployeeName + ", EmployeeAddress=" + EmployeeAddress + ", EmployeeTel=" + EmployeeTel + ", EmployeeEmail=" + EmployeeEmail + ", EmpFirstInDate=" + EmpFirstInDate + '}';
    }
